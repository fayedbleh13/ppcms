        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid mt-4">
                    <div class="mb-4">
                        @if ($order->status <= 1)
                            <a class="btn btn-secondary btn-lg" href="{{ route('user.orders') }}">Back to Current Orders</a>
                        @elseif ($order->status == 2)
                            <a class="btn btn-secondary btn-lg" href="{{ route('user.orders-history') }}">Back to Orders History</a>
                        @else
                            <a class="btn btn-secondary btn-lg" href="{{ route('user.orders-history') }}">Back to Orders History</a>
                        @endif
                            ...
                            <article class="card border shadow">
                                <header class="card-header custom-card-header">
                                    <div class="d-flex justify-content-between">
                                        <strong class="d-inline-block mr-5">Order ID: {{ $order->order_code }}</strong>
                                        <span class="ml-5" style="margin-left: 55em!important;">
                                    ...
                                    <article class="card">
                                        <div class="card-body row no-gutters">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <strong class="mr-1">Subtotal -</strong> ₱ {{ $order->subtotal }}
                                                <br>
                                                <strong class="mr-4">Discount - &nbsp</strong>₱ {{ $order->discount }}
                                                <br>
                                                <strong class="mr-5">Tax -</strong> ₱ {{ $order->tax }}
                                                <br>
                                                <strong class="mr-3"> Total - &nbsp &nbsp</strong>₱ {{ $order->total }}
                                            </div>
                                        </div>
                                    </article>
