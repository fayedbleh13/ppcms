<div class="container">
    <div class="row mt-4">
        <div class="d-flex justify-content-between mb-2 col-md-12 col-lg-12">
            <h2 class="display-5">List of Pending Orders</h2>
            <a href="{{ route('delivery.history') }}" class="btn btn-primary btn-lg">Delivery History</a>
       </div>

        {{-- <div class="col-md-6 col-lg-6"> 
            <h2 class="display-5">Delivery Orders</h2>
        </div>
        <div class="col-md-6 col-lg-6">
            <a href="{{ route('delivery.history') }}" class="btn btn-primary btn-lg">Delivery History</a>
        </div> --}}
