        ...
        <header class="border-bottom mb-4 pb-3">
                <div class="form-inline">
                    {{-- @foreach ($categories as $cat)
                        ...
                        <span class="mr-md mr-5 font-weight-bold">{{ $categories->name }} </span>
                        @else
                        <span class="mr-md mr-5 font-weight-bold"></span>
                        @endif
                    @endforeach --}}
                   
                    <span class="mr-md mr-5 font-weight-bold">Products</span>
                    <span class="ml-md-auto mr-4">{{ $pro_total }} Items found </span>
                    <div>
        ...
        <div class="row">
            @foreach ($products as $product )
                @if($product->stock_status)
                    <div class="col-md-4">
                        <figure class="card card-product-grid border border-primary">
                            <div class="img-wrap"> 
