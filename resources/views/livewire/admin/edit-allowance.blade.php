					...
					<div class="card-body">
						<form  wire:submit.prevent="updateAllowance">
							<div class="form-group">
								...
								<input wire:model.lazy="allowance_name" type="text" class="form-control">
                                <span class="text-danger">@error('allowance_name') {{ $message }} @enderror</span>
							</div>

							<div class="form-group">
								<label for="">Allowance description</label>
								<textarea wire:model.lazy="description" class="form-control" name="" id="" cols="30" rows="3"></textarea>
